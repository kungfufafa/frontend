...
class ApiService extends GetConnect {
  ...
  Future<Response> changePassword(
    ChangePasswordRequest changePasswordData,
  ) async {
  ...
  Future<Response> updateProfile(UpdateProfileRequest profileData) async {
    logDebug(
      'Sending update profile request: ${profileData.toJson()}',
      context: 'ApiService',
    );
  ...
  Future<Response> patchJson(
    ...
    try {
      ...
      logDebug(
        'PATCH request to: $fullUrl with body: $body',
        context: 'ApiService',
      );
  ...
  Future<Response> updateKaryawan(
    int karyawanId,
  ...
  Future<Response> updateTiket(
    int tiketId,
    UpdateTiketRequest tiketData,
  ) async {
  ...
  Future<Response> assignTiketToUnit(
    int tiketId,
    int unitId, {
    int? karyawanId,
    String? komentar,
  ...
  Future<Response> assignTiketToKaryawan(
    int tiketId,
    int karyawanId, {
    String? komentar,
  }) async {
  ...
  Future<Response> updateTiketStatus(
    int tiketId,
    UpdateStatusRequest statusData,
  ) async {
    return patchJson('/tikets/$tiketId/status', statusData.toJson());
  }

  // Komentar endpoints
  Future<Response> getKomentars(
    int tiketId, {
  ...
  Future<Response> createKomentar(
    int tiketId,
    CreateKomentarRequest komentarData,
  ) async {
    return post('/tikets/$tiketId/komentars', komentarData.toJson());
  }

  Future<Response> updateKomentar(
    int komentarId,
  ...
  static void _logRequest(dynamic request) {
    try {
      ...
      final url = request.url.toString().replaceAll(
        'https://skripsipandu.rizqis.com/api/v1',
        '',
      );
  ...
  Future<ApiResponse<List<User>>> getUsersStandardized({
    Map<String, String>? query,
  }) async {
    try {
  ...
  Future<ApiResponse<User>> createUserStandardized(
  ...
  Future<ApiResponse<User>> updateUserStandardized(
    int userId,
    Map<String, dynamic> userData,
  ) async {
    try {
  ...
  Future<ApiResponse<List<Unit>>> getUnitsStandardized({
    Map<String, String>? query,
  }) async {
    try {
  ...
  Future<ApiResponse<Unit>> createUnitStandardized(
  ...
  Future<ApiResponse<Unit>> updateUnitStandardized(
    int unitId,
    Map<String, dynamic> unitData,
  ) async {
    try {
